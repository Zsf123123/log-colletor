...
import com.muheda.*;
import com.muheda.appclient.beans.*;
...
public class AppMain {
    ...
    private static JSONObject generateNotification() {
        ...
        // 客户端弹时间
        appNotification.setApTimel((System.currentTimeMillis() - rand.nextInt(99999999)) + "");
    ...
    private static JSONObject generateComment() {
        ...
        comment.setCommentId(rand.nextInt(5));
